...
const AdminUserData = () => {
  ...
  const handleDeleteUrl = async (id) => {
    const response = await DeleteUserUrl(admintoken, id, userId);
  ...
  if (isLoading) {
    return <h4 style={containerStyle}>Loading...</h4>;
  }
  ...
  return (
    <div style={containerStyle}>
      ...
      <h2 className="mb-5 mt-3">Admin User Data</h2>
      <div className="row">
        {userUrls.length === 0 ? (
          <div className="col">
            <p>No URLs found for this user.</p>
              ...
              <div className="card text-white" style={urlCardStyle}>
                <div className="card-body">
                  ...
                  <p className="card-text">
                    Password Protected: {url.password ? "Yes" : "No"}
                  </p>
                </div>
